...
public interface GymAccountServer {
    ...
    @PostMapping("/account/common"+ ControllerActionContract.OPERATE.EXIST)
    // {"phone":"13012341234"}
    Response userExist(@RequestBody String requestJson);

    @PostMapping("/account/common"+ ControllerActionContract.OPERATE.FIND)
    // {"phone":"13012341234"}
    ...
    @PostMapping("/account/gym_admin_user/"+ControllerActionContract.OPERATE.GET_BIND)
        // {"id":1}
        // {"name":"who"}
        // {"phone":"13012341234"}
...
//    @PostMapping("/account/gym_group_user"+ ControllerActionContract.OPERATE.GET)
//        // {"id":123}
//    Response gymGroupUserGetById(@RequestBody String requestJson);
//
