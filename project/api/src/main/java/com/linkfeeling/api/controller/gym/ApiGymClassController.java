...
@RestController
@RequestMapping("/api/platform/gym_class")
public class ApiGymClassController {
    @Autowired
    ...
    private void init(){
        ...
        // 系统管理员接口
        apiProxyMap.put(ControllerActionContract.OPERATE.ADD,(requestJson -> gymPlatformServer.gymClassAdd(requestJson)));
        apiProxyMap.put(ControllerActionContract.OPERATE.DELETE,(requestJson -> gymPlatformServer.gymClassDelete(requestJson)));
        apiProxyMap.put(ControllerActionContract.OPERATE.UPDATE,(requestJson -> gymPlatformServer.gymClassUpdate(requestJson)));
        apiProxyMap.put(ControllerActionContract.OPERATE.GET,(requestJson -> gymPlatformServer.gymClassGet(requestJson)));
        apiProxyMap.put(ControllerActionContract.OPERATE.LIST,(requestJson -> gymPlatformServer.gymClassListByGymId(requestJson)));

        // 店铺管理员接口
        apiWrapperMap.put(ControllerActionContract.OPERATE.ADD_ME,(request, requestJson) -> wrapGymId(request,requestJson));
        apiProxyMap.put(ControllerActionContract.OPERATE.ADD_ME,(requestJson -> gymPlatformServer.gymClassAdd(requestJson)));

        apiWrapperMap.put(ControllerActionContract.OPERATE.DELETE_ME,(request, requestJson) -> wrapGymId(request,requestJson));
        apiProxyMap.put(ControllerActionContract.OPERATE.DELETE_ME,(requestJson -> gymPlatformServer.gymClassDelete(requestJson)));

        apiWrapperMap.put(ControllerActionContract.OPERATE.UPDATE_ME,(request, requestJson) -> wrapGymId(request,requestJson));
        apiProxyMap.put(ControllerActionContract.OPERATE.UPDATE_ME,(requestJson -> gymPlatformServer.gymClassUpdate(requestJson)));

        apiWrapperMap.put(ControllerActionContract.OPERATE.GET_ME,(request, requestJson) -> wrapGymId(request,requestJson));
        apiProxyMap.put(ControllerActionContract.OPERATE.GET_ME,(requestJson -> gymPlatformServer.gymClassGet(requestJson)));

        apiWrapperMap.put(ControllerActionContract.OPERATE.LIST_ME,(request, requestJson) -> wrapGymId(request,requestJson));
        apiProxyMap.put(ControllerActionContract.OPERATE.LIST_ME,(requestJson -> gymPlatformServer.gymClassListByGymId(requestJson)));
    ...
    public String proxy(HttpServletRequest request, @RequestBody(required = false) String requestJson){
        ...
        String operate = path.substring("/api/platform/gym_class".length());
